...
import {
  useImageDataState, useImagesPathsSettingsState, useImageLoadingState, useImageViewerSettings,
} from '../state/AppState';
  ...
  return (
    ...
    >
      <HorizontalMenu>
        ...
        <HorizontalMenuItem
          title="Landscapes"
          onClick={() => handleSelectPath(imagesPaths.landscapes.default)}
          position={HorizontalMenuItemPosition.left}
        />
        <HorizontalMenuItem
          title="People"
          onClick={() => handleSelectPath(imagesPaths.people.default)}
          position={HorizontalMenuItemPosition.left}
        />
        <HorizontalMenuItem
          title="About"
