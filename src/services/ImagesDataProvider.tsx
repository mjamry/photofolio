...
import {
  ImageDataStateActions, ImageDTO, ImagesDetailsDTO, ImageDataDTO, FileMimeTypes,
} from '../state/ImageDataState';
...
export const useImagesDataProvider = (): ImagesDataProvider => {
  ...
  const initialize = async (): Promise<void> => new Promise<void>((resolve, reject) => {
    gapi.load('client', () => {
      gapi.client
        .init({
